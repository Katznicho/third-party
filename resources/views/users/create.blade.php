...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-600 mt-1">Username and email are required. Everything else is optional.</p>
        </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="username" id="username" value="{{ old('username') }}" placeholder="Enter username" required
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">The user will receive an email to set their password after creation.</p>
            </div>

            @include('users.partials.optional-fields')
            ...
            <div class="flex justify-end space-x-4 pt-4 border-t border-slate-200">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-150">Create User</button>
            </div>
        </form>
    </div>
</div>
