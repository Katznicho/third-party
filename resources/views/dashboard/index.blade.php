...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-slate-900 mt-1">Online</p>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button class="flex items-center justify-center px-4 py-3 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 transition duration-150">
        ...
        <div class="space-y-4">
            <div class="flex items-center p-4 bg-slate-50 rounded-lg">
                ...
                <div class="ml-4 flex-1">
                    <p class="text-sm font-medium text-slate-900">You logged in successfully</p>
                    <p class="text-xs text-slate-500">{{ now()->format('M d, Y h:i A') }}</p>
                </div>
            </div>
