...
@section('page-title', 'Create Policy')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Create New Policy</h1>
            <p class="text-slate-600 mt-1">Add a new insurance policy</p>
        </div>
    ...
    <form action="{{ route('policies.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
        ...
        <div class="border-b border-slate-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="policy_number" id="policy_number" value="{{ old('policy_number', 'POL-' . date('Ymd') . '-' . strtoupper(substr(uniqid(), -6))) }}" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <p class="mt-1 text-xs text-slate-500">Auto-generated if left as is</p>
                    @error('policy_number')
                ...
                <div>
                    ...
                    <select name="principal_member_id" id="principal_member_id" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        @foreach($clients as $client)
                            <option value="{{ $client->id }}" {{ old('principal_member_id') == $client->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="plan_type" id="plan_type" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <option value="Prestige" {{ old('plan_type') === 'Prestige' ? 'selected' : '' }}>Prestige</option>
                        <option value="Executive" {{ old('plan_type') === 'Executive' ? 'selected' : '' }}>Executive</option>
                        <option value="Standard Plus" {{ old('plan_type') === 'Standard Plus' ? 'selected' : '' }}>Standard Plus</option>
                        ...
                        <option value="Budget" {{ old('plan_type') === 'Budget' ? 'selected' : '' }}>Budget</option>
                    </select>
                    @error('plan_type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
        ...
        <div class="border-b border-slate-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="inception_date" id="inception_date" value="{{ old('inception_date') }}" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date') }}" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('expiry_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="desired_start_date" id="desired_start_date" value="{{ old('desired_start_date') }}" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="border-b border-slate-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="total_premium" id="total_premium" value="{{ old('total_premium') }}" step="0.01" min="0" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" oninput="calculateTotalPremiumDue()">
                    @error('total_premium')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="insurance_training_levy" id="insurance_training_levy" value="{{ old('insurance_training_levy', 0) }}" step="0.01" min="0" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" oninput="calculateTotalPremiumDue()">
                ...
                <div>
                    ...
                    <input type="number" name="stamp_duty" id="stamp_duty" value="{{ old('stamp_duty', 35000) }}" step="0.01" min="0" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" oninput="calculateTotalPremiumDue()">
                    @error('stamp_duty')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="total_premium_due" id="total_premium_due" value="{{ old('total_premium_due') }}" step="0.01" min="0" required class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50" readonly>
        ...
        <div class="border-b border-slate-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="agent_broker_name" id="agent_broker_name" value="{{ old('agent_broker_name') }}" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex items-center pt-8">
                    <input type="checkbox" name="is_paid" id="is_paid" value="1" {{ old('is_paid') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 rounded">
                    <label for="is_paid" class="ml-2 block text-sm text-slate-700">Policy is Paid</label>
                </div>

                <!-- Payment Date -->
                <div id="payment-date-field" style="display: {{ old('is_paid') ? 'block' : 'none' }};">
                    <label for="payment_date" class="block text-sm font-medium text-slate-700 mb-2">Payment Date</label>
                    <input type="date" name="payment_date" id="payment_date" value="{{ old('payment_date') }}" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('payment_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="border-b border-slate-200 pb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="has_deductible" id="has_deductible" value="1" {{ old('has_deductible') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 rounded">
                    <label for="has_deductible" class="ml-2 block text-sm text-slate-700">Has Deductible</label>
                </div>

                <!-- Telemedicine Only -->
                <div class="flex items-center">
                    <input type="checkbox" name="telemedicine_only" id="telemedicine_only" value="1" {{ old('telemedicine_only') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 rounded">
        ...
        <div>
            ...
            <textarea name="notes" id="notes" rows="4" class="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes') }}</textarea>
            @error('notes')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
