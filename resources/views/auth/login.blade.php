            ...
            @if ($errors->any())
                <div class="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-red-800 dark:text-red-300 font-medium">Invalid credentials. Please try again.</span>
                    </div>
                </div>
            @endif
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            autofocus
                            class="block w-full pl-10 pr-3 py-3 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150"
