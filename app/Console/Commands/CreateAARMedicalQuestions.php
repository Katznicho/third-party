...
class CreateAARMedicalQuestions extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'medical-questions:create-aar';
     ...
     * @var string
     */
    protected $description = 'Create medical questions for AAR Health Insurance (Code: 61647619)';
