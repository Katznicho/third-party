...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/connected-companies/{connectionId}/local-exclusions/remove', [\App\Http\Controllers\ConnectedCompaniesController::class, 'destroyLocalExclusions'])->name('connected-companies.local-exclusions.destroy');
